...
Without scientific facts, a statistical 
...
1. Structural causal models (synthetic functions that identify in precise mathematical ways the relationships between variables)
