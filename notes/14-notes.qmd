...
1. One feature: one-dimensional distribution
1. Two features: two-dimensional distribution
1. N features: N-dimensional distribution
...
See [here](https://github.com/rmcelreath/stat_rethinking_2023/blob/main/scripts/14_varying_slopes_bangladesh.R#L1-L48) for plotting LKJCorr distributions. 
...
Simulating a synthetic dataset for this kind of complex system is challenging
