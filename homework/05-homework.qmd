...
#| fig-height: 9
predicted_f <- copy(DT_grants)[, gender := 'f'] |> add_predicted_draws(m_h05_q02, value = 'pred_f')
predicted_m <- copy(DT_grants)[, gender := 'm'] |> add_predicted_draws(m_h05_q02, value = 'pred_m')
...
ggplot(m) + 
    ...
    labs(x = 'Difference (female - male) in predicted number of awards')
```
