...
ggplot(gather_emmeans_draws(emmean_pred)) + 
	stat_halfeye(aes(.value, interaction(size, pred, sep = ' - '))) + 
	labs(x = 'Survival', y = 'Size (small / big) - predation (pred / no)')


# Contrasts
cont <- contrast(emmean) |> 
	gather_emmeans_draws()

ggplot(cont) + 
	stat_halfeye(aes(.value, contrast))
```
